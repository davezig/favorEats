  ...
  up: (queryInterface, Sequelize) => {
    return queryInterface.bulkInsert('Restaurants', [
      ...
      },
      {
        ...
        state: 'FL',
        zipCode: 33409,
        img: 'https://okeesteakhouse.com/wp-content/uploads/2020/06/bone-in-ribeye.jpg',
        createdAt: new Date(),
        updatedAt: new Date(),
      },
      {
      ...
      },
      {
        ...
        state: 'Il',
        zipCode: 60646,
        img: 'https://cdn.vox-cdn.com/thumbor/zx-gLX0YYKjCT1-WC0SUdak3xxU=/0x0:3500x2118/1200x0/filters:focal(0x0:3500x2118):no_upscale()/cdn.vox-cdn.com/uploads/chorus_asset/file/19819287/blb23327_49672830403_o.jpg',
        createdAt: new Date(),
        updatedAt: new Date(),
      },
      {
        ...
        state: 'Il',
        zipCode: 60641,
        img: 'https://cdn.vox-cdn.com/thumbor/vQaqHEwWRl7wi_VjlKWwTcWjGf4=/0x0:1000x667/1200x800/filters:focal(420x254:580x414)/cdn.vox-cdn.com/uploads/chorus_image/image/62842059/6945953682_b5dc73bcc6_b.0.0.jpg',
        createdAt: new Date(),
        updatedAt: new Date(),
      },
      {
